...
def add_cover(doc: Document) -> None:
    ...
    for item in [
        ...
        "Помечены черновые данные: номер аттестата RA.RU.____, расхождения телефонов на странице лаборатории.",
...
def build_document() -> Path:
    ...
    notes = [
        "Телефон на главной и в подвале: +7 (812) 240-00-00, info@nic-ecolog.ru",
        "На странице лаборатории в форме контактов указаны другие данные: +7 (812) 449-93-48, info@analitik-lab.ru, адрес ул. Дубровская, 13 — требуется унификация с заказчиком.",
        "Номер аттестата аккредитации: RA.RU.____ — подставить фактический номер.",
